        ...
        <div className={heroLoaded ? 'wrap hero-grid hero-in' : 'wrap hero-grid'}>
          ...
          <div className="hero-content">
            ...
            <div className="hero-mini-trust hero-rise" style={{ transitionDelay: '640ms' }} ref={heroStatsRef}>
              ...
              <div className="mini-stat"><span className="n flap-val" data-target="1" data-suffix="K+">0</span><span className="l">Happy Clients</span></div>
              <div className="mini-stat"><span className="n flap-val" data-target="97" data-suffix="%">0</span><span className="l">Client Satisfaction</span></div>
              <div className="mini-stat"><span className="n flap-val" data-target="200" data-suffix="+">0</span><span className="l">E-Visas</span></div>
              <div className="mini-stat"><span className="n flap-val" data-target="2" data-suffix="K+">0</span><span className="l">Flights Booked</span></div>
              <div className="mini-stat"><span className="n flap-val" data-target="200" data-suffix="+">0</span><span className="l">Hotels Booked</span></div>
            </div>
          </div>
          <div
